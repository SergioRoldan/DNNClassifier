...
Output: Path where the tfrecord of objects has been created
'''
...
def createDataset(client, objs):
    ...
    filename = '../node_serving/records/' + client + '_'
...
If any error happen in the socket the worker signal the error and die
'''
    ...
    try:
        ...
        while True:
            ...
            if 'inference' in message.lower():
                ...
                client = regex.findall(message)

                dataset_path = createDataset(client[0], objs)
